...
export default async function PrivacyPolicyPage({ params }: Props) {
  ...
  return (
    <div className="max-w-[calc(100vw-32px)] mx-auto py-[80px] flex flex-col gap-y-12 lg:gap-y-12">
      <TitleMain
        titleJa="プライバシーポリシー"
        titleEn="Privacy Policy"
        language={language}
      />
      <div className="max-w-[800px] mx-auto leading-7 flex flex-col gap-y-2">
        <p>
      ...
      <div className="bg-white max-w-[1000px] w-full mx-auto px-4 md:px-10 py-6 md:py-12 flex flex-col gap-y-12 leading-7">
