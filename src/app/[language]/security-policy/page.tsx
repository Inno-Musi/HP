          ...
          {language === 'ja' ? (
            ...
            <>
              <p>
                ...
                various threats, both external and internal, and positions their
            ...
            {language === 'ja' ? (
              ...
              <div className="flex flex-col gap-y-4 text-sm md:text-base leading-6 md:leading-7">
                <p>
                  ...
                  environmental measures to prevent unauthorized access, theft,
            ...
            {language === 'ja' ? (
              ...
              <div className="flex flex-col gap-y-4 text-sm md:text-base leading-6 md:leading-7">
                <p>
                  ...
                  event of security incidents (information leaks, system
          ...
          <div className="flex flex-col gap-y-4">
            ...
            {language === 'ja' ? (
              ...
              <p className="text-sm md:text-base leading-6 md:leading-7">
                ...
                accordance with employment rules and may take legal measures as
                necessary.
              </p>
            )}
          </div>
