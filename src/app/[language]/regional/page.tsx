...
const testimonials = [
  {
    quoteJa:
      '構想だけで終わらず、現地に入って実際に事業を立ち上げ・運営まで担ってくれる点が、他社との決定的な違いでした。',
    quoteEn:
      'They don’t stop at plans — they come on-site and actually launch and run the business. That was the decisive difference from other firms.',
    authorJa: '自治体・まちづくり ご担当者',
    authorEn: 'Regional Development Officer',
  },
]
